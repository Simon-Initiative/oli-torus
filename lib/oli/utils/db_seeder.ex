defmodule Oli.Seeder do
  ...
  def base_project_with_resource2() do
    ...
    {:ok, container_revision} = Oli.Resources.create_revision(%{author_id: author.id, objectives: %{}, resource_type_id: Oli.Resources.ResourceType.get_id_by_type("container"), children: [], content: %{}, deleted: false, slug: "curriculum", title: "Curriculum", resource_id: container_resource.id})
