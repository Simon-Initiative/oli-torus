defmodule Oli.Utils.SchemaResolver do
  ...
  @schema_versions %{
    ...
    "content-block.schema.json" => "0.1.1",
    "content-break.schema.json" => "0.1.0",
    "content-element.schema.json" => "0.1.1",
    "content-group.schema.json" => "0.1.1",
    "content-survey.schema.json" => "0.1.1",
    "elements.schema.json" => "0.1.1",
    "page-content-adaptive.schema.json" => "0.1.0",
    "page-content-basic.schema.json" => "0.1.1",
    "page-content.schema.json" => "0.1.1",
    "page.schema.json" => "0.1.1",
    "purpose-type.schema.json" => "0.1.0",
    "resource.schema.json" => "0.1.1",
