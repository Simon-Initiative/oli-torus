defmodule Oli.Utils.DataGenerators.NameGenerator do
  @moduledoc """
  Functions for name data in English

  Forked from https://github.com/elixirs/faker/blob/master/lib/faker/person/en.ex
  """
  import Oli.Utils.DataGenerators.Sampler
  ...
  """
  @spec name() :: String.t()
  def name, do: name(:rand.uniform(9))
