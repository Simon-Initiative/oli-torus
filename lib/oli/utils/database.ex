defmodule Oli.Utils.Database do
  ...
  defp calculate_chunk_size(rows) do
  ...
  Example:
    ...
    ```
  """
  def batch_insert_all(_schema, rows, opts \\ [])
  def batch_insert_all(_schema, [], _opts), do: {0, []}
