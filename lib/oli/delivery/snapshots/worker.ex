defmodule Oli.Delivery.Snapshots.Worker do
  ...
  defp perform_for_section(part_attempt_guids, section) do
    ...
    # LearningModel owns model-version dispatch. The AttemptGroup is intentionally
    # built once and reused so learning model, summaries, and xAPI share the same
    # evaluated attempt set.
