defmodule Oli.Delivery.Attempts do
  ...
  def get_part_attempts_and_users_for_publication(publication_id) do
    student_role_id = Lti_1p3.ContextRoles.get_role(:context_learner).id
    Repo.all(
      ...
      left_join: context_role in Lti_1p3.ContextRole, on: er.context_role_id == context_role.id and context_role.id == ^student_role_id,
