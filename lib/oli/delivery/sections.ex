defmodule Oli.Delivery.Sections do
  ...
  @doc """
  Returns a tuple for the first unfinished (progress < 100%) resource at level 1 (which could be be a page or a container) in a section for a given user.
  The returned tuple contains the resource type and the resource id.

  Example:
  iex> get_first_unfinished_level_1_resource(1, 1)
  {"page", 11}

  iex> get_first_unfinished_level_1_resource(5, 1)
  {"container", 18}

  """

  def get_first_unfinished_level_1_resource(section_id, user_id) do
    min_numbering_index_per_resource =
      from(cp in ContainedPage,
