defmodule Oli.Delivery.Page.PageContext do
  ...
  def create_page_context(section_slug, page_slug, user) do
    ...
    {progress_state, resource_attempts, latest_attempts, activities} = case Attempts.determine_resource_attempt_state(page_revision, section_slug, user.id, activity_provider) do
