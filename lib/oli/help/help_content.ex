defmodule Oli.Help.HelpContent do
  ...
  @subjects %{
    ...
    "help_product_access" => "Product Access",
    "help_publisher_infiniscope" => "Publisher - Infiniscope",
    "help_publisher_inspark" => "Publisher - Inspark",
    "help_publisher_oli" => "Publisher - OLI",
