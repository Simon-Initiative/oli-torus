defmodule Oli.Accounts.User do
  ...
  schema "users" do
    ...
    many_to_many :platform_roles, Lti_1p3.PlatformRole, join_through: "users_platform_roles", on_replace: :delete
...
defimpl Lti_1p3.Lti_1p3_User, for: Oli.Accounts.User do
