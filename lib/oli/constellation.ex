defmodule ECL.Constellation do
  ...
  def send_constellation_request_with_retries(path, data, auth_token, request_type) do
  ...
  def execute_sll_expression(auth_token, mm_expression) do
    ...
    responseObject = search(auth_token, "Object.Software.ManifoldKernel", "Available = true")
