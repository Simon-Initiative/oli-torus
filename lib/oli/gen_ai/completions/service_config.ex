defmodule Oli.GenAI.Completions.ServiceConfig do
  ...
  schema "completions_service_configs" do
    ...
    field :routing_stream_soft_limit, :integer, default: 8
    field :routing_stream_hard_limit, :integer, default: 16
  ...
  def changeset(service_config, attrs) do
    ...
    |> cast(attrs, [
      ...
      :routing_soft_limit,
      :routing_hard_limit,
      :routing_stream_soft_limit,
      :routing_stream_hard_limit,
    ...
    |> validate_number(:routing_stream_soft_limit, greater_than_or_equal_to: 0)
    |> validate_number(:routing_stream_hard_limit, greater_than_or_equal_to: 0)
  ...
  defp validate_stream_soft_limit(changeset) do
    soft_limit = get_field(changeset, :routing_stream_soft_limit)
    hard_limit = get_field(changeset, :routing_stream_hard_limit)
