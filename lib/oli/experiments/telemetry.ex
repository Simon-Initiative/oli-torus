defmodule Oli.Experiments.Telemetry do
  ...
  def emit(
    ...
    emit_operational(:assignment_decided, assignment_attribution(decision, request, opts))
  end
  ...
  def emit(
    ...
    emit_operational(:exposure_recorded, exposure_attribution(receipt, request, opts))
  end
  ...
  def emit(
    ...
    emit_operational(:outcome_recorded, outcome_attribution(receipt, request, opts))
  end
  ...
  def emit(
    ...
    emit_operational(:reward_recorded, reward_attribution(receipt, request, opts))
  end
  ...
  def emit(:policy_updated, {%{} = update, %{} = reward}, opts) do
    emit_operational(:policy_updated, policy_update_evidence(update, reward, opts))
  end
