defmodule Oli.Experiments do
  ...
  defp validate_runtime_condition_compatibility(experiment, decision_point, revision) do
    ...
    validate_condition_option_mapping(revision, conditions)
  end
  ...
  defp create_exposure(request) do
    Repo.transaction(fn ->
      ...
      case validate_exposure_revision(assignment, request) do
        :ok ->
  ...
  defp validate_exposure_revision(assignment, request) do
