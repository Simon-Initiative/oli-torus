defmodule OliWeb.Workspaces.CourseAuthor.Datasets.JobShortcuts do
  ...
  alias OliWeb.Workspaces.CourseAuthor.Datasets.JobConfig

  @shortcuts [
    %{
      value: :datashop,
      label: "Datashop (.xml)",
      description: "An XML file containing student interaction data, formatted for the Datashop data mining tool."
    },
    %{
      value: :attempts_simple,
      label: "Attempt performance data (.csv)",
      description: "A CSV file containing student attempt performance data for part, activity and page attempts."
    },
    %{
      value: :attempts_extended,
      label: "Attempt performance data, extended fields (.csv)",
      description: "A CSV file containing student attempt performance data for part, activity and page attempts, with additional (large) fields including student reponse and system feedback"
    },
    %{
      value: :video,
      label: "Video interaction data (.csv)",
      description: "A CSV file containing interaction data (play, pause, seek, complete) for course videos."
    },
    %{
      value: :page_viewed,
    ...
    %{
      ...
      description: "A CSV file containing student responses to the required course survey."
    }
  ...
  def configure(:attempts_simple, section_ids) do
    {:custom, %JobConfig{
      ...
      event_sub_types: ["part_attempt_evaluted", "activity_attempt_evaluated", "page_attempt_evaluted"],
      page_ids: [],
      ignored_student_ids: [],
