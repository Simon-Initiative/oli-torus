        ...
        <div class="accordion-header" id={"heading_#{@post.id}"}>
          <div class="card border-post my-3">
            ...
            <div class="card-body pb-2">
              ...
              <hr class="bg-light"/>
              <div class="d-flex justify-content-between align-items-center" phx-update="ignore">
                ...
                <div>
                  {#if @post.user_id == @user.id}
                    ...
                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title={if @post.replies_count > 0, do: "Post cannot be deleted because it has replies", else: "Delete"}>
                    ...
                    <div class="d-flex justify-content-between align-items-center" phx-update="ignore">
                      ...
                      <div>
                        {#if reply.user_id == @user.id}
                          ...
                          <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title={if has_replies?(@post.replies, reply.id), do: "Reply cannot be deleted because it has replies", else: "Delete"}>
