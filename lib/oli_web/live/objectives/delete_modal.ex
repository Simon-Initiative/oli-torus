      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <Attachments attachment_summary={@attachment_summary} project={@project} id="attachments" />
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            <button phx-click="delete" phx-value-slug={@slug} phx-key="enter" class="btn btn-warning">
              Delete
            </button>
          </div>
        </div>
