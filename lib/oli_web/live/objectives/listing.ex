        ...
        <div id={item.slug} class="card max-w-full border border-light mb-3 p-0">
          <div class="card-header d-flex justify-content-between p-2" id={"heading#{index}"}>
            ...
            <div class="d-flex flex-column font-weight-light small bg-secondary p-2 rounded pr-4">
              <div><i class="fa fa-cubes c0183 mr-1" />Sub-Objectives {item.sub_objectives_count}</div>
              <div><i class="far fa-file c0183 mr-1" />Pages {item.page_attachments_count}</div>
              <div><i class="fa fa-list mr-1" />Activities {item.activity_attachments_count}</div>
            </div>
          </div>
              ...
              <div class="mb-3">
                ...
                <ul class="list-group list-group-flush">
                  {#for sub_objective <- item.children}
                    ...
                    <div class="border border-light w-75" />
                  {/for}
                </ul>
              </div>
              <div class="mb-3">
