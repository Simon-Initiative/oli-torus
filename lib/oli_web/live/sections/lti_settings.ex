defmodule OliWeb.Sections.LtiSettings do
  ...
  def render(assigns) do
    ...
    <Group.render label="LTI Settings" description="Settings defined in the LMS that is launching students and instructors into this course section">
      ...
      <ReadOnly label="Names and Role Provisioning Service Enabled" value={boolean(@section.nrps_enabled)} />
      <ReadOnly label="Names and Role Provisioning Service URL" value={@section.nrps_context_memberships_url} />
    </Group.render>
    """
  end
end
