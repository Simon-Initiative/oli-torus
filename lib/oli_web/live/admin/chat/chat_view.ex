defmodule OliWeb.Admin.ChatView do
  ...
  alias OliWeb.Admin.Messages
  alias OliWeb.Admin.Input
      ...
      %{
        ...
        replies: [
          %{
            ...
            id_parent: 1,
            replies: [
              %{id: 5, text: "Reply 4", author: author, id_parent: 3},
              %{id: 6, text: "Reply 5", author: author, id_parent: 3}
            ]
          },
          %{id: 4, text: "Reply 2", author: author, id_parent: 1}
        ]
      },
      %{
        id: 2,
        ...
        replies: []
        # replies: [
        #   %{id: 1, text: "Reply 1", author: author, id_parent: 2},
        #   %{id: 1, text: "Reply 1", author: author, id_parent: 2}
        # ]
      }
    ]
    ...
    ~F"""
      <div class="chatroom col-12">
        <div class="row">
          <div class="col-8">
            <h4>{topic(123)}</h4>
            <Messages messages={@messages} msg={@msg} typing="typing" stop_typing="stop_typing" save_message="save_message"/>
            <Input button_text={"Post comment"} msg={@msg} typing="typing" stop_typing="stop_typing" save_message="save_message"/>
          </div>
          <div class="col-4">
  ...
  def handle_event(
        "save_message",
        %{"message" => %{"message" => message, "parent_msg_id" => parent_msg_id}} = params,
        socket
      ) do
    IO.inspect(params)

    case parent_msg_id do
      "" ->
