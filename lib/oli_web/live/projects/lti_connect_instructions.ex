          ...
          <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            ...
            <div class="modal-body relative p-4">
              <div class="text-center">
                ...
                <p>Connect your institution's LMS using LTI 1.3 to deliver course materials to students.</p>
                <br>
                  ...
                  <div class="tab-content text-left p-3" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-canvas" role="tabpanel" aria-labelledby="pills-canvas-tab">
                      <p>
                        ...
                        a new developer key. Using the <strong>Enter JSON URL</strong> option, copy the url below and paste into the JSON URL field.
                      </p>

                      <div class="mt-2">
                        <strong>Developer Key JSON URL:</strong>
                        <div class="input-group input-group-sm mb-3">
                          <input type="text" id="canvas_developer_key_url" class="form-control" value={@lti_connect_info.canvas_developer_key_url} phx-hook="LtiConnectInstructions" readonly>
                          <div class="input-group-append">
                            <button id="btnDeveloperKey" class="clipboardjs btn btn-xs btn-outline-primary" data-clipboard-target="#canvas_developer_key_url" phx-hook="CopyListener">
                        ...
                        <div>
                          <input id="course_navigation_default" type="checkbox" phx-hook="LtiConnectInstructions">
                          <label for="course_navigation_default">Disable course navigation placement by default</label>
                        </div>
                      </div>
                    </div>
                    ...
                    {#if @lti_connect_info.blackboard_application_client_id}
                      <div class="tab-pane fade" id="pills-blackboard" role="tabpanel" aria-labelledby="pills-other-tab">
                        <p>
                          ...
                          Use the <strong>Client ID</strong> below to configure Torus as an LTI 1.3 tool.
                        </p>
                        ...
                        <div>
                          ...
                          <div class="input-group input-group-sm mb-3">
                            ...
                            <div class="input-group-append">
                              <button id="btnClientId" class="clipboardjs btn btn-xs btn-outline-primary" data-clipboard-target="#blackboard_application_client_id" phx-hook="CopyListener">
