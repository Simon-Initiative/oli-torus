      ...
      <li class="list-group-item">
        <div class="d-flex flex-row align-items-center">
          ...
          <%= if @show_actions do %>
            ...
            <.icon_button class="danger-icon-button mr-1" icon="fa-solid fa-trash" on_click="show_delete_option_modal" values={["phx-value-resource-id": @group.resource_id, "phx-value-option-id": @option["id"]]} />
          <% end %>
        </div>
      </li>
    """
