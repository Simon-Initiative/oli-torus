              ...
              <%= if !is_container?(@revision) do %>
                <div class="form-group">
                  ...
                  <%= select(
                    f,
                    :graded,
                    ["Graded Assessment": "true", "Ungraded Practice Page": "false"],
                    class: "custom-select",
                    class: "form-control",
                    aria_describedby: "gradingType",
                    placeholder: "Grading Type"
                  ) %>
                  <small id="gradingType" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <%= inputs_for f, :explanation_strategy, fn es -> %>
                    <div class="d-flex d-flex-row">
                      ...
                      <%= case fetch_field(es.source, :type) do %>
                        <% :after_set_num_attempts -> %>
                          <div class="ml-2">
                            <%= number_input(es, :set_num_attempts,
                              class: "form-control",
                    ...
                    <small id="scoringStrategy" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <%= select(f, :max_attempts, @attempt_options,
                    class: "custom-select",
                  ...
                  <small id="numberOfAttempts" class="form-text text-muted">
                ...
                <div class="form-group">
                  ...
                  <small id="retakeMode" class="form-text text-muted">
