defmodule OliWeb.Grades.GradesLive do
  ...
  def mount(
        ...
        %{"lti_params" => lti_params, "current_user" => current_user},
        socket
      ) do
  ...
  defp determine_grade_sync_tasks(section_slug, graded_page, line_item, students) do
    ...
    resource_accesses =
      Attempts.get_resource_access_for_page(section_slug, graded_page.resource_id)
  ...
  defp access_token_provider(lti_launch_params) do
    ...
    {registration, _deployment} =
      Lti_1p3.Tool.get_registration_deployment(issuer, client_id, deployment_id)
