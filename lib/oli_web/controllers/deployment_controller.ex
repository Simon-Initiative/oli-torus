defmodule OliWeb.DeploymentController do
  ...
  def new(conn, %{"institution_id" => institution_id, "registration_id" => registration_id}) do
    ...
    render(conn, "new.html", changeset: changeset, institution_id: institution_id, registration_id: registration_id, title: "Create Deployment")
  end
  ...
  def edit(conn, %{"institution_id" => institution_id, "registration_id" => registration_id, "id" => id}) do
    deployment = Institutions.get_deployment!(id)
    changeset = Institutions.change_deployment(deployment)
    render(conn, "edit.html", deployment: deployment, changeset: changeset, institution_id: institution_id, registration_id: registration_id, title: "Edit Deployment")
  end

  def update(conn, %{"institution_id" => institution_id, "registration_id" => registration_id, "id" => id, "deployment" => deployment_params}) do
    deployment = Institutions.get_deployment!(id)
  ...
  def delete(conn, %{"institution_id" => institution_id, "registration_id" => _registration_id, "id" => id}) do
    deployment = Institutions.get_deployment!(id)
