defmodule OliWeb.Router do
  ...
  scope "/project", OliWeb do
    ...
    get "/:project_id/objectives/:objective_slug/edit", ProjectController, :edit_objective
    get "/:project_id/objectives/:objective_slug/add", ProjectController, :add_sub_objective
