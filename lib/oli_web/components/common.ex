defmodule OliWeb.Components.Common do
  ...
  def loading_spinner(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: none; display: block; shape-rendering: auto;" width={"#{@size_px}px"} height={"#{@size_px}px"} viewBox={"#{Kernel.div(@size_px, 4)} #{Kernel.div(@size_px, 4)} #{@size_px} #{@size_px}"} preserveAspectRatio="xMidYMid">
