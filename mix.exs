defmodule Oli.MixProject do
  ...
  defp deps do
    [
      ...
      {:joken, "~> 2.2.0"},
      {:jose, "~> 1.10"},
      {:lti_1p3, git: "git@github.com:Simon-Initiative/lti_1p3.git", branch: "master", override: true},
      {:lti_1p3_ecto_provider, git: "git@github.com:Simon-Initiative/lti_1p3_ecto_provider.git", branch: "master"},
      {:libcluster, "~> 3.3"},
      {:libcluster_ec2, "~> 0.6"},
      {:mime, "~> 1.2"},
