defmodule Oli.Repo.Migrations.CreatePartComponentRegistrations do
  ...
  def change do
    ...
    create unique_index(:part_component_registrations, [:slug], name: :index_part_component_slug_registrations)
    ...
    create table(:part_component_registration_projects, primary_key: false) do
      timestamps(type: :timestamptz)
      add :part_component_registration_id, references(:part_component_registrations), primary_key: true
    ...
    create unique_index(:part_component_registration_projects, [:part_component_registration_id, :project_id],
