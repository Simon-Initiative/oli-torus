defmodule Oli.Repo.Migrations.CascadeDeletePublishedResource do
  use Ecto.Migration

  def change do
    # This is doing the same thing that Oli.Repo.Migrations.FixPreviousMigration did, but
    # with making one more change in the middle.

    drop_trigger()
    drop_materialized_view()

    alter table(:published_resources) do
      modify(:publication_id, references(:publications, on_delete: :delete_all),
        from: references(:publications)
      )
    end
