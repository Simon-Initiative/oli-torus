 ...
 */
export function accepted_parser_inputs() {
  return toList([
    "2",
    "2.0",
    "1.23e-4",
 ...
 */
export function rejected_parser_inputs() {
  return toList(["2^^3", "1,000", "tan x", "sqrt()", "(x+1", "|x-2", "2+"]);
}
 ...
 */
export function precedence_inputs() {
  return toList(["2+3*4", "2*3+4", "2^3^4", "-x^2", "(-x)^2", "2x^2", "1/2x"]);
}
