...
7. Apply `references/philosophy.md` as a hard design lens before selecting architecture options.
8. Copy section blocks from `assets/templates/fdd_template.md` into `<feature_dir>/fdd.md`.
...
13. If validation cannot run, instruct the user to run it and report failures.
14. REQUIREMENTS TRACEABILITY (required):
