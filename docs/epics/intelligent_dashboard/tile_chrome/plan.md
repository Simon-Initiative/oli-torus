...
- PRD: `docs/epics/intelligent_dashboard/tile_chrome/prd.md`
- FDD: `docs/epics/intelligent_dashboard/tile_chrome/fdd.md`
...
- Assumption: the user request `chrome_tile` refers to `docs/epics/intelligent_dashboard/tile_chrome`.
...
- Tasks:
  ...
  - [ ] Reconcile `docs/epics/intelligent_dashboard/dashboard_ui_composition.md` and this feature pack if implementation details drift.
- Testing Tasks:
