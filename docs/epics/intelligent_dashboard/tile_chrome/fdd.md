...
- What we know:
  - `docs/epics/intelligent_dashboard/dashboard_ui_composition.md` currently places the reusable chrome under `intelligent_dashboard`, but its own responsibility statement describes a dashboard-generic wrapper; that boundary is too narrow for actual reuse.
