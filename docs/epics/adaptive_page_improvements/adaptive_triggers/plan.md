...
- Tasks:
  - [x] Run `mix format`.
  - [x] Run targeted ExUnit coverage for adaptive trigger descriptions.
...
- Testing Tasks:
  - [x] Command(s): `mix test test/oli/conversation/triggers_test.exs`
  - [x] Command(s): `yarn test --runInBand test/parts/ai_trigger_test.tsx test/parts/navigation_button_ai_trigger_test.tsx test/parts/image_ai_trigger_test.tsx test/advanced_authoring/part_component_types_test.ts`
- Definition of Done:
