...
- Manual validation:
  - Create and activate a Thompson Sampling experiment through the A/B Testing authoring surface, then inspect analytics or monitoring evidence showing reward counts and posterior state changes after controlled student attempts.
