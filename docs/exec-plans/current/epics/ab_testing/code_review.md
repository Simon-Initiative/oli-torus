...
- [ ] 4.1 Handle failures while loading a selected decision point.
- [ ] 4.2 Move reward handoff out of synchronous activity evaluation.
- [ ] 4.3 Batch reward processing during page grading.
