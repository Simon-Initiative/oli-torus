...
- Automated validation:
  ...
  - Reward tests for threshold boundaries, attempt ordering, pending or ineligible attempts, missing assignments, duplicate and concurrent processing, completion freeze, and learner-attempt rollback when synchronous reward processing fails.
