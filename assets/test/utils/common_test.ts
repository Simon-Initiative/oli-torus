...
describe('parser', () => {
  it('renders well-formed content properly', () => {
    ...
    expect(htmlString).toContain('<img  style="display: block; max-height: 500px; margin-left: auto; margin-right: auto;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Declaration_of_Independence_%281819%29%2C_by_John_Trumbull.jpg/480px-Declaration_of_Independence_%281819%29%2C_by_John_Trumbull.jpg"/>');
