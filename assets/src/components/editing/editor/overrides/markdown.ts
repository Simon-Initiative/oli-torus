  ...
  editor.insertText = (text) => {
    ...
    if (isTopLevel(editor)
      ...
      if (type) {
        ...
        switch (type) {
          case 'h1': return setNodes('h1');
          case 'h2': return setNodes('h2');
          case 'ul': return ulCmd.command.execute(context, editor);
          case 'ol': return olCmd.command.execute(context, editor);
          case 'blockquote': return quoteCmd.command.execute(context, editor);
          case 'code': return codeCmd.command.execute(context, editor);
        }
      }
    }
