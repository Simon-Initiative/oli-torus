...
export const DarkModeSelector = ({
  ...
  const activeStrokeClass = showLabels ? 'stroke-gray-900' : 'stroke-gray-900 dark:stroke-white';
  const activeFillClass = showLabels ? 'fill-gray-900' : 'fill-gray-900 dark:fill-gray-100';
  const hoverStrokeClass = showLabels ? undefined : 'hover:stroke-gray-900 hover:dark:stroke-white';
  const labelClassName = showLabels ? 'text-gray-900' : undefined;
    ...
    <fieldset className="border-0 p-0 m-0">
      ...
      >
        <ToggleOption
          ...
          srLabel={showLabels ? undefined : 'auto'}
        >
          <svg
            className={classNames(
              isChecked(mode, 'auto') && 'hidden',
              showLabels ? baseStrokeClass : classNames(baseStrokeClass, hoverStrokeClass),
              isChecked(mode, 'auto') && activeStrokeClass,
            )}
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          <svg
            className={classNames(
              !isChecked(mode, 'auto') && 'hidden',
              showLabels ? activeFillClass : classNames(activeFillClass),
            )}
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          >
            <path
              className={classNames(showLabels ? activeFillClass : activeFillClass)}
          ...
          {showLabels && (
            <span className={classNames(isChecked(mode, 'auto') ? labelClassName : '')}>
              System
            </span>
          )}
        </ToggleOption>
        <ToggleOption
          ...
          className={optionClassName}
          checkedClassName={checkedClassName}
          srLabel={showLabels ? undefined : 'light mode'}
        >
          <svg
            width="20"
            height="20"
            ...
            className={classNames(
              baseStrokeClass,
              !showLabels && hoverStrokeClass,
              isChecked(mode, 'light') && activeStrokeClass,
            )}
          >
            <path
              className={classNames(isChecked(mode, 'light') && activeFillClass)}
          ...
          {showLabels && (
            <span className={classNames(isChecked(mode, 'light') ? labelClassName : '')}>
              Light
            </span>
          )}
        </ToggleOption>
        <ToggleOption
          ...
          className={optionClassName}
          checkedClassName={checkedClassName}
          srLabel={showLabels ? undefined : 'dark mode'}
        >
          <svg
            className={classNames(
              baseStrokeClass,
              !showLabels && hoverStrokeClass,
              isChecked(mode, 'dark') && activeStrokeClass,
            )}
            width="20"
            height="20"
            viewBox="0 0 20 20"
          ...
          >
            <path
              className={classNames(isChecked(mode, 'dark') && activeFillClass)}
          ...
          {showLabels && (
            <span className={classNames(isChecked(mode, 'dark') ? labelClassName : '')}>Dark</span>
          )}
        </ToggleOption>
      </ThreeStateToggle>
    </fieldset>
