...
const Video: React.FC<any> = (props) => {
  ...
  useEffect(() => {
    ...
    props.onInit({
      ...
      responses: [
        {
          id: `stage.${id}.hasStarted`,
          key: 'hasStarted',
          type: CapiVariableTypes.BOOLEAN,
          value: videoIsPlayerStarted,
        },
        {
          id: `stage.${id}.autoPlay`,
          key: 'autoPlay',
          type: CapiVariableTypes.BOOLEAN,
          value: videoAutoPlay,
        },
        ...
        {
          id: `stage.${id}.exposureInSeconds`,
          key: 'exposureInSeconds',
          type: CapiVariableTypes.NUMBER,
          value: startTime,
        },
        {
          id: `stage.${id}.exposureInPercentage`,
          key: 'exposureInPercentage',
          type: CapiVariableTypes.NUMBER,
          value: 0,
        },
        {
          id: `stage.${id}.hasCompleted`,
          key: 'hasCompleted',
          type: CapiVariableTypes.BOOLEAN,
          value: false,
        },
        {
          id: `stage.${id}.startTime`,
          key: 'startTime',
          type: CapiVariableTypes.STRING,
          value: startTime || 0,
        },
        ...
        {
          id: `stage.${id}.totalSecondsWatched`,
          key: 'totalSecondsWatched',
          type: CapiVariableTypes.STRING,
          value: startTime,
        },
        {
          id: `stage.${id}.enableReplay`,
          key: 'enableReplay',
          type: CapiVariableTypes.BOOLEAN,
