...
export { LikertDelivery } from './LikertDelivery';
export { LikertAuthoring } from './LikertAuthoring';

// Registers the creation function:
import { Manifest, CreationContext } from '../types';
import { registerCreationFunc } from '../creation';
import { LikertModelSchema } from './schema';
import { defaultLikertModel } from './utils';

// eslint-disable-next-line
const manifest: Manifest = require('./manifest.json');

function createFn(content: CreationContext): Promise<LikertModelSchema> {
  return Promise.resolve(Object.assign({}, defaultLikertModel()));
}
