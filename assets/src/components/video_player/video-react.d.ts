/**
 * Temporary fix for video-react typings issue until DefinitelyTyped pr is merged.
 * https://github.com/DefinitelyTyped/DefinitelyTyped/pull/61391
 * After that's in, we can `yard add @types/video-react` and delete this file.
 */
...
declare module 'video-react' {
  ...
  interface ClosedCaptionButtonProps extends ControlBarControlProps {
    actions?: any;
    offMenuText?: string;
    showOffMenu?: boolean;
    kinds?: string[];
  ...
  interface ControlBarControlProps {
    order?: number;
    className?: string;
  ...
  interface TimeDividerProps extends ControlBarControlProps {
    separator?: string;
  }
