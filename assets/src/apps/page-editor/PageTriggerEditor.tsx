  ...
  return trigger != undefined ? (
    <div className="mt-3 bg-white dark:bg-gray-600 rounded-lg p-3" contentEditable={false}>
      <div className="flex justify-between">
        ...
        <button onClick={() => onEdit(undefined)} className="btn btn-primary">Disable</button>
      </div>
      <p className="mt-2">
      ...
      <p>When a student visits this page, DOT will engage with the student guided by
        the prompt you provide below.
      </p>
    ...
    <div className="mt-3 bg-white dark:bg-gray-600 rounded-lg p-3" contentEditable={false}>
      <div className="flex justify-between">
        ...
        <button onClick={() => onEdit({id: "page", type: "trigger", trigger_type: "page", prompt: ""})} className="btn btn-primary">Enable</button>
      </div>
    </div>
  )
});