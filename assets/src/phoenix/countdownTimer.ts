...
export function initCountdownTimer(timerId: string, submitButtonId: string, timeOutInMins: number, startTimeInMs: any, effectiveTimeInMs: any, autoSubmit: boolean) {
...
export function initEndDateTimer(timerId: string, submitButtonId: string, effectiveTimeInMs: any, autoSubmit: boolean) {
