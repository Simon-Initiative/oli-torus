...
const expandLocale = function (localeParam) {
...
const getPluralFunc = function (pluralForm) {
    ...
    return new Function('n', 'var plural, nplurals; ' + pluralForm +
...
const t = function (messages, n, options) {
    // Singular is very easy, just pass dictionnary message through strfmt
    if (!options.plural_form) {
        return strfmt.apply(undefined, [removeContext(messages[0])].concat(Array.prototype.slice.call(arguments, 3)));
    }
    let plural;
    ...
    return strfmt.apply(undefined, [removeContext(messages[plural.plural]), n].concat(Array.prototype.slice.call(arguments, 3)));
};
export function setMessages(domain, locale, messages, pf) {
...
export function loadJSON(jsonDataP, domain) {
    let jsonData;
...
export function gettext(msgid) {
    return dcnpgettext.apply(undefined, [undefined, undefined, msgid, undefined, undefined].concat(Array.prototype.slice.call(arguments, 1)));
}
export function ngettext(msgid, msgidPlural, n) {
    return dcnpgettext.apply(undefined, [undefined, undefined, msgid, msgidPlural, n].concat(Array.prototype.slice.call(arguments, 3)));
}
export function pgettext(msgctxt, msgid) {
    return dcnpgettext.apply(undefined, [undefined, msgctxt, msgid, undefined, undefined].concat(Array.prototype.slice.call(arguments, 2)));
}
export function dcnpgettext(d, msgctxt, msgid, msgidPlural, n) {
    domain = d || domain;
    ...
    // Singular form
    if (!msgidPlural) {
        return t.apply(undefined, [[translation], n, options].concat(Array.prototype.slice.call(arguments, 5)));
    }
    // Plural one
    options.plural_form = true;
    return t.apply(undefined, [exist ? translation : [msgid, msgidPlural], n, options].concat(Array.prototype.slice.call(arguments, 5)));
}
/*eslint-enable */
