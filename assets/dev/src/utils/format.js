...
export const convert = {
     ...
     */
    toByteNotation: (value, decimalPlaces = 2) => {
...
export const stringFormat = {
     ...
     */
    ellipsize: (text, maxLength, postfixLength = 0) => {
     ...
     */
    ellipsizePx: (text, maxWidth, fontFamily, fontSize, fontWeight, fontStyle) => {
