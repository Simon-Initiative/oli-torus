...
export const inRangeOperator = (factValue, value) => {
    const parsedValue = parseArray(value);
    const modifiedFactValue = typeof factValue === 'string' && factValue.indexOf('e') === -1
...
export const notInRangeOperator = (factValue, value) => !inRangeOperator(factValue, value);
const operators = {
