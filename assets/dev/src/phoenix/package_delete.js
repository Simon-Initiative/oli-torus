...
export function enableSubmitWhenTitleMatches(inputSelector, submitSelector, encodedTitle) {
    const deleteTitleInput = document.querySelector(inputSelector);
    if (deleteTitleInput) {
        deleteTitleInput.addEventListener('input', function (e) {
            const value = e.target.value;
            const deleteSubmitButton = document.querySelector(submitSelector);
...
//# sourceMappingURL=package_delete.js.map