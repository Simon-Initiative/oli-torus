...
/*eslint-disable */
const Markup = ({ tag, href, src, target, style = {}, text = '', children, state = {}, customCssClass = '', displayRawText = false, env = new Environment(), }) => {
    /*eslint-enable */
    ...
    const renderStyles = Object.assign({}, styleFilter(style));
    ...
    switch (renderTag) {
        case 'a':
            return (<a ref={el} key={key} className={customCssClass} href={href} target={target} style={Object.assign(Object.assign({}, renderStyles), { display: 'inline' })}>
          {processedText}
          {children}
        </a>);
        case 'span':
            return (<span ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </span>);
        case 'strong':
        case 'b':
            return (<strong ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </strong>);
        case 'em':
        case 'i':
            return (<em ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </em>);
        case 'div':
            return (<div ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </div>);
        case 'h1':
            ...
            return (<h1 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h1>);
        case 'h2':
            return (<h2 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h2>);
        case 'h3':
            return (<h3 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h3>);
        case 'h4':
            return (<h4 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h4>);
        case 'h5':
            return (<h5 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h5>);
        case 'h6':
            return (<h6 ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </h6>);
        case 'p':
            ...
            return (<p ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </p>);
        case 'sub':
            return (<sub ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </sub>);
        case 'sup':
            return (<sup ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </sup>);
        case 'small':
            ...
            return (<small ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </small>);
        case 'code':
            return (<code ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </code>);
        case 'blockquote':
            return (<blockquote ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </blockquote>);
        case 'ol':
            return (<ol ref={el} key={key} className={customCssClass} style={renderStyles}>
          {processedText}
          {children}
        </ol>);
        case 'ul':
            delete renderStyles.width;
            return (<ul ref={el} key={key} className={customCssClass} style={Object.assign(Object.assign({}, renderStyles), { paddingLeft: '40px' })}>
          {processedText}
          {children}
        </ul>);
        case 'li':
            ...
            const listStyle = Object.assign(Object.assign({}, renderStyles), { display: 'list-item' });
            ...
            return (<li ref={el} key={key} className={customCssClass} style={listStyle}>
          {processedText}
          {children}
        </li>);
        case 'br':
        ...
        case 'img':
            if ((renderStyles === null || renderStyles === void 0 ? void 0 : renderStyles.width) === 'auto') {
                renderStyles.width = '';
            }
            if ((renderStyles === null || renderStyles === void 0 ? void 0 : renderStyles.height) === 'auto') {
                renderStyles.height = '';
            }
