...
const QuillEditor = ({ tree, html, showSaveCancelButtons = false, onChange, onSave, onCancel, showimagecontrol = false, }) => {
    const [contents, setContents] = React.useState(tree);
    const [delta, setDelta] = React.useState(convertJanusToQuill(tree));
    ...
    const handleQuillChange = React.useCallback((content, delta, source, editor) => {
    ...
    return (<React.Fragment>
      ...
      <div style={{
        ...
        <ReactQuill style={{ maxHeight: '100%' }} modules={{
            toolbar: {
                container: [
...
//# sourceMappingURL=QuillEditor.jsx.map