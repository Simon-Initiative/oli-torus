...
export const transformModelToSchema = (model) => {
    ...
    const result = Object.assign(Object.assign({}, model), { popup: {
            partsLayout: popup.partsLayout,
            Size: { width, height },
            Position: { x, y, z },
