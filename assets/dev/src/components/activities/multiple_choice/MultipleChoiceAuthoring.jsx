    ...
    return (<>
      <TabbedNavigation.Tabs>
        <TabbedNavigation.Tab label="Question">
          ...
          <ChoicesAuthoring icon={<Radio.Unchecked />} choices={model.choices} addOne={() => dispatch(Choices.addOne(ActivityTypes.makeChoice('')))} setAll={(choices) => dispatch(Choices.setAll(choices))} onEdit={(id, content) => dispatch(Choices.setContent(id, content))} onRemove={(id) => dispatch(Actions.removeChoice(id))}/>
        </TabbedNavigation.Tab>
        <TabbedNavigation.Tab label="Answer Key">
          <StemDelivery stem={model.stem} context={defaultWriterContext()}/>

          <ChoicesDelivery unselectedIcon={<Radio.Unchecked />} selectedIcon={<Radio.Checked />} choices={model.choices} selected={[getCorrectChoice(model).id]} onSelect={(id) => dispatch(Actions.toggleChoiceCorrectness(id))} isEvaluated={false} context={defaultWriterContext()}/>
        ...
        }} addTargetedResponse={() => dispatch(Actions.addTargetedFeedback())} unselectedIcon={<Radio.Unchecked />} selectedIcon={<Radio.Checked />}/>
        </TabbedNavigation.Tab>
...
//# sourceMappingURL=MultipleChoiceAuthoring.jsx.map