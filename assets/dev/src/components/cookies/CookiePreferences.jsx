    ...
    return (<div>
      ...
      <div className="accordion" id="preferenceAccordion">
        <div className="card z-depth-0 bordered">
          ...
          <div id="collapseOne" className="collapse" aria-labelledby="headingOne" data-parent="#preferenceAccordion">
        ...
        <div className="card z-depth-0 bordered">
          <div className="card-header d-flex justify-content-between" id="headingTwo">
            ...
            <div className="custom-control custom-switch d-inline-block">
              <input type="checkbox" className="custom-control-input" id="functionalCookies" checked={functionalActive} onChange={(e) => prefChange(e.target.id, e.target.checked)}/>
              <label className="custom-control-label small pt-1" htmlFor="functionalCookies">
                {functionalLabel}
              </label>
            </div>
          </div>
          <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#preferenceAccordion">
            <div className="card-body">
              <div className="mb-2">
                <p>
        ...
        <div className="card z-depth-0 bordered">
          <div className="card-header d-flex justify-content-between" id="headingThree">
            ...
            <div className="custom-control custom-switch d-inline-block">
              <input type="checkbox" className="custom-control-input" id="analyticsCookies" checked={analyticsActive} onChange={(e) => prefChange(e.target.id, e.target.checked)}/>
              <label className="custom-control-label small pt-1" htmlFor="analyticsCookies">
                {analyticsLabel}
              </label>
            </div>
          </div>
          <div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#preferenceAccordion">
            <div className="card-body">
              <div className="mb-2">
                <p>
        ...
        <div className="card z-depth-0 bordered">
          <div className="card-header d-flex justify-content-between" id="headingFour">
            ...
            <div className="custom-control custom-switch d-inline-block">
              <input type="checkbox" className="custom-control-input" id="targetingCookies" checked={targetingActive} onChange={(e) => prefChange(e.target.id, e.target.checked)}/>
              <label className="custom-control-label small pt-1" htmlFor="targetingCookies">
                {targetingLabel}
              </label>
            </div>
          </div>
          <div id="collapseFour" className="collapse" aria-labelledby="headingFour" data-parent="#preferenceAccordion">
            <div className="card-body">
              <div className="mb-2">
                <p>
...
export function selectCookiePreferences() {
    const cookiePreference = (<ModalSelection title="Cookie Preferences" onInsert={() => {
            dismiss();
            savePreferences();
        }} onCancel={() => {
            dismiss();
        }} okLabel="Save my preferences" cancelLabel="Cancel">
      <CookiePreferences />
    </ModalSelection>);
...
//# sourceMappingURL=CookiePreferences.jsx.map