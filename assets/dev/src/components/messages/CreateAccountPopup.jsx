...
export function CreateAccountPopup(props) {
    ...
    const onClick = (e) => {
        e.nativeEvent.createAccountPopupClick = true;
    };
    return (<CSSTransition in={show} appear={true} timeout={300} unmountOnExit>
        ...
        <div className="d-flex mt-4">
          <div className="btn-group">
            ...
            <div className="dropdown-menu">
              <button className="btn btn-sm btn-link dropdown-item text-left" onClick={() => onDontAskAgain()}>
          ...
          <a href={`/course/create_account?section=${props.sectionSlug}`} className="btn btn-sm btn-outline-primary ml-1">
            Create account
          </a>
          <a href={`/course/signin?section=${props.sectionSlug}`} className="btn btn-sm btn-primary ml-1">
            Sign in
          </a>
        </div>
      </div>
...
//# sourceMappingURL=CreateAccountPopup.jsx.map