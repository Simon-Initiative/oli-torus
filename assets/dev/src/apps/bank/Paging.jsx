...
export const Paging = (props) => {
    ...
    for (let i = 0; i < renderedPages; i++) {
        pages.push(<li className={`page-item ${start + i === currentPage ? 'active' : ''}`}>
        <a className="page-link" onClick={() => onPageChange({ offset: (start + i) * page.limit, limit: page.limit })}>
          {i + 1}
        </a>
      </li>);
    }
...
//# sourceMappingURL=Paging.jsx.map