...
export const templatizeText = (text, state, env, isFromTrapStates = false) => {
    let innerEnv = env;
    ...
    if (isFromTrapStates) {
        ...
        const matchingCssElements = text.match(/^(([a-z0-9\\[\]=:]+\s?)|((div|span|body.*|.button:hover.*|.button.*|.box-sizing:*|.columns-container.*|background-color.*)?(#|\.){1}[a-z0-9\-_\s?:]+\s?)+)(\{[\s\S][^}]*})$/im);
    ...
    const vals = vars.map((v) => {
        ...
        if (!stateValue || typeof stateValue === 'object') {
            try {
                ...
                innerEnv = result.env;
                if ((result === null || result === void 0 ? void 0 : result.result) && !((_a = result === null || result === void 0 ? void 0 : result.result) === null || _a === void 0 ? void 0 : _a.message)) {
