...
import { selectIsGraded, selectPreviewMode, selectResourceAttemptGuid, } from '../../store/features/page/slice';
const RestartLessonDialog = ({ onRestart }) => {
    ...
    return (<Fragment>
      ...
      <div className="RestartLessonDialog modal in" data-keyboard="false" aria-hidden={!isOpen} style={{ display: isOpen ? 'block' : 'none', top: '20%', left: '50%' }}>
        <div className="modal-header">
          <button type="button" className="close" title="Close Restart Lesson window" aria-label="Close Restart Lesson window" data-dismiss="modal" onClick={handleCloseModalClick}>
            ×
          </button>
...
//# sourceMappingURL=RestartLessonDialog.jsx.map