...
import { selectEnableHistory, selectPreviewMode, selectShowHistory, setShowHistory, } from 'apps/delivery/store/features/page/slice';
      ...
      <div className={`displayOptionsView${open ? '' : ' displayNone'}`}>
        ...
        <div className={`option navigationOption${enableHistory ? '' : ' displayNone'}`}>
          ...
          <div className="state navigationBtn">
            <button className={`on btn${showHistory ? '' : ' displayNone'}`} aria-label="Close history panel" onClick={() => handleToggleHistory(false)}>
              <div className="left">ON</div>
            </button>
            <button className={`off btn${!showHistory ? '' : ' displayNone'}`} aria-label="Open history panel" onClick={() => handleToggleHistory(true)}>
        ...
        <div className={`option restartOption${enableHistory ? '' : ' displayNone'}`}>
          <button className="restartBtn btn" aria-label="Open restart lesson window" onClick={handleRestartLesson}>
            Restart Lesson
          </button>
        </div>
...
//# sourceMappingURL=OptionsPanel.jsx.map