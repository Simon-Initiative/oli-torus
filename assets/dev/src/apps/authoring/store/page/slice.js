...
const slice = createSlice({
    ...
    reducers: {
        ...
        setRevisionSlug(state, action) {
            state.revisionSlug = action.payload.revisionSlug;
        },
    },
});
export const PageSlice = slice.name;
export const { loadPage, setIsGraded, setTitle, setObjectives, setRevisionSlug, updatePage } = slice.actions;
...
export const selectObjectives = createSelector(selectState, (state) => state.objectives);
export const selectResourceId = createSelector(selectState, (state) => state.resourceId);
