...
const CompJsonEditor = (props) => {
    ...
    return (<Fragment>
      ...
      <Modal show={displayEditor} onHide={() => setDisplayEditor(false)}>
        ...
        <Modal.Footer>
          <button id="btnSave" type="button" className="btn btn-success" onClick={() => {
...
//# sourceMappingURL=CompJsonEditor.jsx.map