...
export const transformModelToSchema = (model) => {
    ...
    const result = {
        ...
        custom: Object.assign({}, model.custom),
    };
...
export const transformSchemaToModel = (schema) => {
    ...
    const result = {
        id,
        type,
        custom: Object.assign(Object.assign({}, schema.custom), { x: Position.x, y: Position.y, z: Position.z, width: Size.width, height: Size.height }),
    };
    if (palette) {
