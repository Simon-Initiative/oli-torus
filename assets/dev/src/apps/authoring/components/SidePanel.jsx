...
export const SidePanel = (props) => {
    ...
    return (<>
      <button className={`aa-panel-side-toggle ${position}${panelState[position] ? ' open' : ''} btn btn-secondary btn-sm m-0 p-0 d-flex justify-content-center align-items-center`} onClick={() => onToggle()}>
...
//# sourceMappingURL=SidePanel.jsx.map