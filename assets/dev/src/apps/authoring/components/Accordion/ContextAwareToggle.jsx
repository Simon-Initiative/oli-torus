...
const ContextAwareToggle = ({ eventKey, callback, className }) => {
    ...
    return (<button type="button" ref={toggleButtonRef} className={`btn btn-link p-0 mr-1 ${className ? className : ''}`} onClick={decoratedOnClick}>
      {isCurrentEventKey ? (<i className="fa fa-angle-down"></i>) : (<i className="fa fa-angle-right"></i>)}
    </button>);
};
export default ContextAwareToggle;
//# sourceMappingURL=ContextAwareToggle.jsx.map