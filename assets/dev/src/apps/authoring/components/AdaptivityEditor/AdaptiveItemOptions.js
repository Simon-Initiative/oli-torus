...
export const actionOperatorOptions = [
...
export const conditionTypeOperatorCombos = [
...
export const inferTypeFromOperatorAndValue = (operator, value) => {
    const typeCombos = conditionTypeOperatorCombos.filter((combo) => combo.operators.includes(operator));
...
//# sourceMappingURL=AdaptiveItemOptions.js.map