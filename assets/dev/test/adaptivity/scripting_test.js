...
import { applyState, evalScript, getAssignScript, getValue, getExpressionStringForValue, looksLikeJson, } from 'adaptivity/scripting';
...
describe('Scripting Interface', () => {
    ...
    describe('getAssignScript', () => {
        ...
        it('should assign variable expression value and calculate the expression', () => {
            const environment = new Environment();
            evalScript('let {stage.vft.Score} = 1;let {stage.vft.Map complete}=0;let {session.tutorialScore}=0', environment);
            const varValue = '{stage.vft.Score}*70 + {stage.vft.Map complete}*100 - {session.tutorialScore}';
            const script = getAssignScript({
                x: {
                    key: 'score',
                    path: 'stage.x',
    ...
    describe('getExpressionStringForValue', () => {
        ...
        it('should allow full janus-script expressions to be assigned', () => {
            ...
            const variable4 = {
                ...
                key: 'x',
                value: '[{e:1617736969329:1|stage.HeatSourceSorting.Content Slots.Slot 1},{e:1617736969329:1|stage.HeatSourceSorting.Content Slots.Slot 2}]',
            };
            const variable5 = {
                type: CapiVariableTypes.ARRAY,
                key: 'x',
            ...
            expect(script).toBe('{stage.vft.Score}*70 + {stage.vft.Map complete}*100 - {session.tutorialScore}');
            ...
            expect(script).toBe('[{e:1617736969329:1|stage.HeatSourceSorting.Content Slots.Slot 1},{e:1617736969329:1|stage.HeatSourceSorting.Content Slots.Slot 2}]');
        ...
        it('should deal with CSS that looks like expressions', () => {
            const cssVal = '@font-face{font-family:PTSerif;src:url(https://dev-etx.ws.asu.edu/fonts/PT%20Serif/PT_Serif-Web.ttf)}';
            const variable = {
                type: CapiVariableTypes.STRING,
                value: cssVal,
            };
...
//# sourceMappingURL=scripting_test.js.map