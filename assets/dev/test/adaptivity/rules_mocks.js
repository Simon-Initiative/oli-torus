            ...
            actions: [
                {
                    ...
                    params: {
                        ...
                        targetType: 2,
                        operator: '=',
                        value: "<color=#3686FF>CREW MEMBER: I've matched the test object speed to the small world speed. Can you confirm?</color>",
                    },
                },
                {
                    type: 'mutateState',
...
export const getAttemptScoringContext = (attempts = 1, maxScore = 5, maxAttempt = 5, negativeScoreAllowed = false) => ({
    maxScore,
    maxAttempt,
...
//# sourceMappingURL=rules_mocks.js.map