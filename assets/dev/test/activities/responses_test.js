...
import { makeChoice, makeFeedback, makeResponse, } from 'components/activities/types';
...
describe('responses', () => {
    ...
    it('can edit feedback', () => {
        ...
        expect(dispatch(model, ResponseActions.editResponseFeedback(firstFeedback.id, newFeedbackContent))
            .authoring.parts[0].responses[0].feedback).toHaveProperty('content', newFeedbackContent);
    });
    it('can edit rules', () => {
...
//# sourceMappingURL=responses_test.js.map