import { findInSequence, findInSequenceByResourceId, getHierarchy, } from 'apps/delivery/store/features/groups/actions/sequence';
...
describe('Sequence Util Methods', () => {
    ...
    describe('findInSequence', () => {
        it('should return a sequence entry by looking for the sequence id', () => {
            ...
            expect(entry === null || entry === void 0 ? void 0 : entry.custom.sequenceName).toBe('Sequence Item 2');
        });
...
//# sourceMappingURL=sequence_test.js.map