...
if runtime_env == :prod do
  ...
  config :oli,
    ...
    genai_hackney_fast_pool_size:
      String.to_integer(
        System.get_env("GENAI_FAST_POOL_SIZE", System.get_env("GENAI_HACKNEY_POOL_SIZE", "100"))
      ),
    genai_hackney_slow_pool_size:
      String.to_integer(
        System.get_env("GENAI_SLOW_POOL_SIZE", System.get_env("GENAI_HACKNEY_POOL_SIZE", "100"))
      ),
