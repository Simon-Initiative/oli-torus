...
config :oli,
  ...
  project_export_storage_backend: System.get_env("PROJECT_EXPORT_STORAGE_BACKEND", "s3"),
  project_export_local_output_dir:
    System.get_env("PROJECT_EXPORT_LOCAL_OUTPUT_DIR", "tmp/project_exports"),
