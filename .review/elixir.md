...
> Use this file during PR review to quickly spot maintainability and
functional issues with Elixir code. Prefer small, surgical suggestions with file/line references.
...
```elixir
scope "/admin", OliWeb.Admin do
  pipe_through :browser
  live "/users", UserLive, :index
end
# → OliWeb.Admin.UserLive
```
...
- [ ] Name LiveViews like `OliWeb.ThingLive`.
