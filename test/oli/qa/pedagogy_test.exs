defmodule Oli.Qa.PedagogyTest do
  ...
  describe "qa pedagogy checks" do
    ...
    test "no attached activities", %{project: project, review: review, pages: pages, page_has_activities: page_has_activities,
      page_has_objectives: page_has_objectives} do
