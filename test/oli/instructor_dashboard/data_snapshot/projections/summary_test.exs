defmodule Oli.InstructorDashboard.DataSnapshot.Projections.SummaryTest do
  ...
  describe "derive/2" do
    test "builds a partial summary projection from available optional inputs" do
    ...
    test "returns ready when all optional summary inputs are present" do
      ...
      assert projection.summary_tile.scope_label == "Unit 1"
    end
  end
  ...
  defp snapshot_fixture(overrides \\ %{}) do
    default_oracles = %{
      oracle_instructor_progress_proficiency: [
        %{student_id: 1, progress_pct: 50.0, proficiency_pct: 0.8},
        %{student_id: 2, progress_pct: 100.0, proficiency_pct: 0.9}
      ],
      oracle_instructor_objectives_proficiency: %{
        objective_rows: [
          %{objective_id: 1, title: "Objective 1", proficiency_distribution: %{"High" => 2}},
          %{objective_id: 2, title: "Objective 2", proficiency_distribution: %{"Medium" => 1}}
        ]
      },
      oracle_instructor_scope_resources: %{
        scope_label: "Unit 1",
