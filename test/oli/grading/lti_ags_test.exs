defmodule Oli.Grading.LTI_AGS_Test do
  ...
  @lti_params %{
    ...
    "https://purl.imsglobal.org/spec/lti/claim/launch_presentation" => %{
      ...
      "locale" => "en",
      "return_url" =>
        "https://canvas.oli.cmu.edu/courses/8/external_content/success/external_tool_dialog",
      "validation_context" => nil,
      "width" => 800
    },
  ...
  test "basic helpers" do
    ...
    assert LTI_AGS.get_line_items_url(@lti_params) ==
             "https://canvas.oli.cmu.edu/api/lti/courses/8/line_items"

    lti_ags_claim = Map.get(@lti_params, "https://purl.imsglobal.org/spec/lti-ags/claim/endpoint")

    assert LTI_AGS.has_scope?(
             lti_ags_claim,
             "https://purl.imsglobal.org/spec/lti-ags/scope/lineitem.readonly"
           )

    refute LTI_AGS.has_scope?(
             lti_ags_claim,
