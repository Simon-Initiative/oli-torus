defmodule Oli.Analytics.Summary.BrowseInsightsTest do
  ...
  describe "browse insights query, section_id = -1" do
    setup do
      ...
      insert_summaries(map.project.id, [
        ...
        [a1.resource.id, a1.revision.resource_type_id, map.publication.id, -1, "part1", 1, 2, 0, 1, 1],
        [a1.resource.id, a1.revision.resource_type_id, map.publication.id, -1, "part2", 2, 3, 0, 1, 1],
        [a2.resource.id, a2.revision.resource_type_id, map.publication.id, -1, "part1", 3, 4, 0, 1, 1],
        [a2.resource.id, a2.revision.resource_type_id, map.publication.id, -1, "part2", 4, 5, 0, 1, 1],
        [a3.resource.id, a3.revision.resource_type_id, map.publication.id, -1, "part1", 5, 6, 0, 1, 1],
        [a3.resource.id, a3.revision.resource_type_id, map.publication.id, -1, "part2", 6, 7, 0, 1, 1],
    ...
    test "browsing activities, basic query operation, paging", %{
      ...
      results = BrowseInsights.browse_insights(
  ...
  describe "browse insights query, specific section_ids" do
    setup do
      ...
      insert_summaries(map.project.id, [
        ...
        [a1.resource.id, a1.revision.resource_type_id, map.publication.id, 2, "part1", 1, 2, 0, 1, 1],
        [a1.resource.id, a1.revision.resource_type_id, map.publication.id, 2, "part2", 2, 3, 0, 1, 1],
        [a2.resource.id, a2.revision.resource_type_id, map.publication.id, 2, "part1", 3, 4, 0, 1, 1],
        [a2.resource.id, a2.revision.resource_type_id, map.publication.id, 2, "part2", 4, 5, 0, 1, 1],
        [a3.resource.id, a3.revision.resource_type_id, map.publication.id, 2, "part1", 5, 6, 0, 1, 1],
        [a3.resource.id, a3.revision.resource_type_id, map.publication.id, 2, "part2", 6, 7, 0, 1, 1],
  ...
  defp insert_summaries(project_id, entries) do
    ...
    augmented_entries = Enum.map(entries, fn [
      resource_id,
      resource_type_id,
      pub_id,
      section_id,
