  ...
  setup do
    ...
    on_exit(fn ->
      Enum.each(original, fn
        ...
        {:aws_access_key_id, nil} -> System.delete_env("AWS_ACCESS_KEY_ID")
        {:aws_secret_access_key, nil} -> System.delete_env("AWS_SECRET_ACCESS_KEY")
        {:aws_s3_access_key_id, nil} -> System.delete_env("AWS_S3_ACCESS_KEY_ID")
        {:aws_s3_secret_access_key, nil} -> System.delete_env("AWS_S3_SECRET_ACCESS_KEY")
        {:aws_access_key_id, value} -> System.put_env("AWS_ACCESS_KEY_ID", value)
        {:aws_secret_access_key, value} -> System.put_env("AWS_SECRET_ACCESS_KEY", value)
        {:aws_s3_access_key_id, value} -> System.put_env("AWS_S3_ACCESS_KEY_ID", value)
        {:aws_s3_secret_access_key, value} -> System.put_env("AWS_S3_SECRET_ACCESS_KEY", value)
      end)
    end)
