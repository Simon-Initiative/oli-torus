  ...
  describe "html activity renderer" do
    ...
    test "renders well-formed activity properly", %{author: author} do
      ...
      assert rendered_html_string =~
               "<oli-multiple-choice-delivery id=\"activity_1\" class=\"activity-container\" bib_params=\"W10=\" graded=\"false\" state=\"{ \"active\": true }\" model=\"{ \"choices\": [ \"A\", \"B\", \"C\", \"D\" ], \"feedback\": [ \"A\", \"B\", \"C\", \"D\" ], \"stem\": \"\"}\""
    end
