defmodule Oli.Content.Activity.HtmlTest do
  ...
  describe "html activity renderer" do
    ...
    test "renders well-formed activity properly", %{author: author} do
      ...
      "<h4 class=\"activity-purpose none\">None</h4><oli-multiple-choice-delivery id=\"activity_1\" class=\"activity-container\"  bib_params=\"W10=\" graded=\"false\" state=\"{ \"active\": true }\" model=\"{ \"choices\": [ \"A\", \"B\", \"C\", \"D\" ], \"feedback\": [ \"A\", \"B\", \"C\", \"D\" ], \"stem\": \"\"}\" mode=\"delivery\" user_id=\"1875\" section_slug=\"\"></oli-multiple-choice-delivery>\n"
    end
