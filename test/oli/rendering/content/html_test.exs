defmodule Oli.Content.Content.HtmlTest do
  ...
  describe "html content renderer" do
    ...
    test "renders internal course links through student section preview when preview params are present",
         %{author: author} do
      {:ok, content} = read_json_file("./test/oli/rendering/content/example_content.json")
      ...
      assert rendered_html_string =~
               "<a class=\"internal-link\" href=\"/sections/some_section/preview/page/page_two?section_preview_kind=student\">Page Two</a>"
    end
