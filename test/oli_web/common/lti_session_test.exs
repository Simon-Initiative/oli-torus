defmodule OliWeb.Common.LtiSessionTest do
  ...
  describe "lti session" do
    ...
    test "should put the lti params key for a particular user's section in the lti session", %{
      conn: conn
    } do
    ...
    test "should get the lti params key for a particular platform and user's section in the lti session",
         %{conn: conn} do
      conn = LtiSession.put_section_params(conn, "some-section-slug", "some-cache-key")
