defmodule OliWeb.CookieConsentControllerTest do
        ...
        post(
          ...
          cookies: [
            %{
              ...
              value: ~s({"necessary":true,"functionality":true,"analytics":false,"targeting":false})
            }
          ]
        )
  ...
  describe "sync cookies on login" do
    test "syncs browser cookies to database when user has no existing preferences", %{conn: conn} do
      ...
      cookie_value = ~s({"necessary":true,"functionality":false,"analytics":true,"targeting":false})
    ...
    test "does not create duplicate records on subsequent logins", %{conn: conn} do
      ...
      cookie_value = ~s({"necessary":true,"functionality":true,"analytics":false,"targeting":false})
